...
define('DB_HOST', $_ENV['DB_HOST'] ?? 'db5019204584.hosting-data.io');
define('DB_USER', $_ENV['DB_USER'] ?? 'dbu1777501');
define('DB_PASS', $_ENV['DB_PASS'] ?? 'vegetta777alepsaurio777');
define('DB_NAME', $_ENV['DB_NAME'] ?? 'dbs15074779');
