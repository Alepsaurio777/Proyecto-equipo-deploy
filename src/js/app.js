...
function setupEventListeners() {
  ...
  if (cancelLogoutBtn)
    cancelLogoutBtn.addEventListener("click", closeLogoutDialog);
  ...
  if (closeRecoveryBtn)
    closeRecoveryBtn.addEventListener("click", closePasswordRecovery);
  const recoveryActionBtn = document.getElementById("recoveryActionBtn");
  if (recoveryActionBtn)
    recoveryActionBtn.addEventListener("click", handleRecoveryAction);
